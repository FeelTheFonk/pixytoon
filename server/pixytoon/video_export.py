...
log = logging.getLogger("pixytoon.video_export")
...
def export_mp4(
    ...
    # Our frames are frame_001.png, frame_002.png, ...
    ...
    if ffmpeg is None:
        raise FileNotFoundError(
            "ffmpeg not found in PATH. Install ffmpeg or set PIXYTOON_FFMPEG_PATH."
        )
    ...
    # Video filter: nearest-neighbor scaling for pixel art
    if scale_factor > 1:
        cmd.extend([
            "-vf", f"scale=iw*{scale_factor}:ih*{scale_factor}:flags=neighbor",
        ])
